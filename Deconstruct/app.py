...
""", unsafe_allow_html=True)  # <-- CLEANLY VERIFIED

# App Headers
st.markdown('<div class="main-header">De-Construct</div>', unsafe_allow_html=True)  # <-- FIXED
st.markdown('<div class="sub-header">Requirements Ingestion & Market Discovery Engine</div>', unsafe_allow_html=True)  # <-- FIXED
st.divider()
